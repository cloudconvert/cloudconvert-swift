...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, QLPreviewControllerDataSource {
    ...
    override func viewDidLoad() {
        ...
        CloudConvert.apiKey = "l3vcbCE4NgOlq4zHNrNltMeeV31OMCiXtnFaxc_euoctF9CFUvSiE_p6DVAaz2-8NoFKsu7VCWdjFc1GmGw-dg"
        ...
        CloudConvert.conversionTypes(parameters: ["inputformat" : "fb2"], completionHandler: { [weak self] (conversionTypes, error) -> Void in
    ...
    @IBAction func convert(_ sender: AnyObject) {
        ...
        if process != nil {
            ...
            let imageURL = Bundle.main.url(forResource: "bok",withExtension: "fb2")!

            process = CloudConvert.convert(parameters: [
                "inputformat": "fb2",
                ...
                "download": true
                                           ...
                                           progressHandler: { [weak self] (step, percent, message) -> Void in
                                            DispatchQueue.main.async {
                                                ...
                                                if let step = step, let percent = percent, let message = message {
